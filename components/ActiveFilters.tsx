...
export function ActiveFilters({
  ...
  return (
    <div className="w-full pt-6 pb-[24px] px-[106px] border-t border-[#E2E8F0]">
...
function FilterTag({ label, onRemove }: FilterTagProps) {
  return (
    <div className="inline-flex items-center gap-[6px] py-1.5 px-4 border border-[#CBD5E1] rounded-lg bg-white">
